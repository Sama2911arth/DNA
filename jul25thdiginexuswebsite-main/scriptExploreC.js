...
// Add event listeners only if carousel element exists
if (carousel) {
...
function setCarouselPosition() {
  // Apply constraints to prevent scrolling beyond content
  if (carousel) {
    ...
    const maxTranslate = containerWidth - carouselWidth;
